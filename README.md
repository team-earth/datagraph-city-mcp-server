...
```
/home/kkells/datagraph-city-mcp-server/index.js  ← WRONG! This is sync target only!
```
...
**Monorepo (EDIT HERE):**
- `/home/kkells/datagraph.city/mcp-server/` ← **YOUR DEVELOPMENT LOCATION**
...
- `/home/kkells/datagraph-city-mcp-server/` ← **SYNC TARGET ONLY**
...
❌ Editing `/home/kkells/datagraph-city-mcp-server/index.js`
✅ Edit `/home/kkells/datagraph.city/mcp-server/index.js` instead

❌ Committing to `team-earth/datagraph-city-mcp-server` directly
✅ Commit to `kevinkells/datagraph.city`, then sync

❌ Forgetting to sync before publishing to npm
✅ Run `./scripts/sync-mcp-to-public.sh` first
